...
const exercise6 = () => {
  ...
  let style =
    "background-color: #0d6efd; font-weight: bold; font-size: 1rem; padding: .5em 1.2em;";
  let style2 =
    "background-color: #0d6efd; color: white; font-weight: bold; font-size: 1rem; padding: .5em 1em;";
  console.log("%cLenght:%c%i characters", style, style2, results.stringLength);
  console.log(
    "%cLength witout white-spaces:%c%i characters",
    style,
    style2,
    results.cleanStringLenght
  );
  ...
  console.log(
    ...
    style,
    style2,
    results.minWordLenght
  );
  console.log(
    "%cLength of longest word:%c%i characters",
    style,
    style2,
    results.maxWordLenght
  );
  console.log(
    "%cAvg. word length:%c%i",
    style,
    style2,
    results.averageWordLenght
  );
};
// exercise6();
